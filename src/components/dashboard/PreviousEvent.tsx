...
export function PreviousEvent({event,className}: PreviousEventProps) {
    ...
    const onEventClick = (clickPosition: { x: number, y: number }, event: Event) => {
    ...
    return (
        <div className={className + " hover:bg-gray-100 p-2 rounded-md cursor-pointer bg-gray-50 after:bg-primary/70 relative pl-6 text-sm" +
